...
version = find_version("jaxsw", "__init__.py")
...
setup(
    ...
    license="LICENSE",
    description="Differentiable Shallow Water Models in Jax",
    ...
    keywords=["jax shallow-water finite-volume machine-learning sciml"],
)